...
Vous pouvez télécharger une version exécutable pour Windows http://gofile.me/48Z1V/czGfRNIuV (c'est une version allégée, qui permet uniquement de joindre une partie créée par quelqu'un d'autre).
